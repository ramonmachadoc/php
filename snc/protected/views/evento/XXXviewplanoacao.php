<div class="panel panel-default">
	<div class="panel-heading" style="background-color:#fff !important">
		...
		<!-- Planos e acao -->
		<?php if(count($model->planosacao) > 0) : ?>
			
			<h3><i class="glyphicon glyphicon-eye-open"></i> Plano de Ação</h3>

			<!-- Listagem dos planos de acao -->
			<?php foreach ($model->planosacao as $key => $plano) : ?>
				<div class="panel-body" id="yw0">
					<h4><?php echo $key+1 . "º"; ?> Plano de Ação</h3>
				  	<?php $this->widget('booster.widgets.TbDetailView',array(
						'type'=>'bordered condensed striped',
						'data'=>$contencao,
						'attributes'=>array(
							array('label' => 'Responsável',   'value' => $plano->responsavel->nome),
							'acaocorrecao',
							'prazo',
						),
					));?>	
