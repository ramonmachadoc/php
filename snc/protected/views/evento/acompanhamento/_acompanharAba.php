    ...
    'columns'         => array(
        ...
        array(
            ...
            'buttons'         => array(
                ...
                'acompanhar' => array(
                    'label'   => 'Realizar Acompanhamento',
                    'icon'    => 'fa fa-share',
                    'url'     => 'Yii::app()->createUrl("evento/realizaracompanhamento", array("evento"=>Utils::encodeGET($data->primaryKey)))',
