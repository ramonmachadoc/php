...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'auditorrelator_id'); ?>
		<?php echo $form->textField($model,'auditorrelator_id'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'setor',array('size'=>60,'maxlength'=>80)); ?>
	</div>
