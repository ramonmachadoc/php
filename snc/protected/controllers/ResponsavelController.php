...
class ResponsavelController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes = $_POST['Responsavel'];

			if($model->save())
				$this->redirect(array('view','id'=>$model->responsavel_id));
		}
	...
	{
		$model=new Responsavel('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Responsavel']))
			$model->attributes=$_GET['Responsavel'];
	...
	{
		$model=Responsavel::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Responsavel $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='responsavel-form')
		{
