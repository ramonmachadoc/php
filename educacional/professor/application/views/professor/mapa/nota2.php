<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-calendar"></i> 2BIM</li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
        ...
        <h2 style="font-weight: 300;"></span> 2º BIMESTRE</h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php echo form_open('Mapa/nota2/' . $ArrayIds['turma_id'] . "/" . $ArrayIds['disciplina_id'], array('class' => '', 'enctype' => 'multipart/form-data')); ?>
                <section class="panel">
                                    ...
                                    foreach ($alunos as $row):
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td style="width: 7%; text-align: center;" >
                                                ...
                                                ?> class="form-control" value="<?php echo $row['dan_fl_nota_2bim']; ?>" type="text" name="nota<?php echo $row['disciplina_aluno_nota_id']; ?>"/>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
