                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            <a href="<?php echo base_url(); ?>notificacao/add/<?php echo $matricula_aluno_id; ?>"><button class="btn btn-primary"><span class="glyphicon glyphicon-plus">
                                    </span> NOTIFICAÇÃO</button>
                            </a>
                        </header>
                                        ...
                                        foreach ($notificacao as $row):
                                            ...
                                            <tr class="gradeU">
                                                ...
                                                <td class="center hidden-phone">
                                                    ...
                                                    <a data-toggle="modal" href="#myModal2<?php echo $cont++; ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i>
                                                        </button>
                                                    </a>
                                            </tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title">Excluir Notificação</h4>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="<?php echo base_url(); ?>/notificacao/delete/<?php echo $row['notificacao_id']; ?>/<?php echo $matricula_aluno_id; ?>"><button class="btn btn-warning" type="button"> Confirmar</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
