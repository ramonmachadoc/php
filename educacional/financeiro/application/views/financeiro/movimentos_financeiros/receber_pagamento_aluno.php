<section id="main-content">
    <section class="wrapper">
        ...
        <div class="col-lg-12">
            <section class="panel">
                <div class="panel-heading"><strong><span class="glyphicon glyphicon-th"></span> RECEBER PAGAMENTO ALUNO</strong></div>
...
<script>
                                                function buscar_periodo_letivo() {
                                                    ...
                                                    if (curso) {
                                                        var url = 'ReceberPagamento/carregaPeriodoLetivo/' + curso;  //caminho do arquivo php que irá buscar as cidades no BD
                                                ...
                                                function buscar_turma() {
                                                    ...
                                                    //se encontrou o estado
                                                    if (curso) {
                                                        var url = 'ReceberPagamento/carregaTurma/' + curso + '/' + periodo_letivo;  //caminho do arquivo php que irá buscar as cidades no BD
                                                        $.get(url, function (dataReturn) {
                                                ...
                                                function buscar_paginacao_receber_pagamento() {
                                                    ...
                                                    if ((aluno) || (curso != '0') || (turma != '0')) {
                                                        var url = 'ReceberPagamento/PesquisaAlunos/' + curso + '/' + turma + '/' + aluno + '/' + periodo;  //caminho do arquivo php que irá buscar as cidades no BD
                                                        $.get(url, function (dataReturn) {
