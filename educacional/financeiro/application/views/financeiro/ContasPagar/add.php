                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php echo form_open('despesas/add', array('enctype' => 'multipart/form-data', 'id' => 'FormAddFornecedor')); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" data-mask="99/99/9999" name="cpr_dt_vencimento" required="required" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label>Valor</label>
                                                <input type="text" name="cpr_db_valor" required="required" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="cpr_tx_num_documento"  class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3" id="parcela" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" maxlength="2" name="parcelas"  class="form-control" required="required">
                                            </div>
                                        </div>
