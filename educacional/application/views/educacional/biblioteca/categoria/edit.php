<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <section class="panel">
                    <div class="panel-heading"><strong><span class="glyphicon glyphicon-tasks"></span> ATUALIZAR CATEGORIA</strong></div>
                            ...
                            <div class="col-lg-12">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <?php echo form_open('biblioteca/updateCategoria/'.$categoria['categoria_livro_id'], array('enctype' => 'multipart/form-data', 'id' => 'FormEditCategoria')); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nome" value="<?php echo $categoria['nome']; ?>" id="nome" minlength="5" required="required" class="form-control">
                                                </div>
                                            </div>
