...
class Usuario extends CI_Controller {
    ...
    public function usuario($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            $this->agape_model->save('usuario', $dados);
        ...
        if ($param1 == 'update') {
            ...
            $this->agape_model->update($dados, 'usuario', $param2);
        ...
        if ($param1 == 'delete') {
            ...
            $this->agape_model->delete('usuario', $param2);
            $this->session->set_flashdata('message', '<strong>USUÁRIO</strong> excluido com sucesso!');
            $this->session->set_flashdata('type', 'warning');
            redirect(base_url() . 'usuario/usuario');
        }

        $page_data['dadosUsuario'] = $this->agape_model->GetWhere('usuario', 'login <>','admin');
    ...
    public function update($param1 = '') {
        ...
        $page_data['updateUsuario'] = $this->agape_model->getUpdate('usuario', $param1);
        $page_data['page_title'] = 'Usuário';
