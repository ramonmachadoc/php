...
<!--                                    <div style="width: 700px;  height: 35px; text-align: justify; font-weight: bold;  font-size: 30px; margin-top: 10px;"> MATRIZ <br/> <?php echo $InfoMatriz['cur_tx_abreviatura'] . "-" . $InfoMatriz['mat_tx_ano'] . "/" . $InfoMatriz['mat_tx_semestre'] ?></div>-->
                                ...
                                <div class="adv-table">
                                    <table style="font-size: 12px;"  class="display table table-bordered" id="example">
                                        ...
                                        foreach ($periodos as $rowPeriodo):
                                           ...
                                           <tr style="font-size: 14px;" >
                                            ...
                                            <?php
                                            $disciplinas = $this->agape_model->DisciplinasMatrizImprimir($matriz_id, $rowPeriodo['periodo']);


                                            foreach ($disciplinas as $rowDisc):
                                                ?>
                                                <tr <?php if($rowDisc['status'] == 1){ echo 'class="bg-success"'; }else {echo 'class="bg-danger"';} ?>  style="text-align: justify;" >
                                            ...
                                            <tr style="font-size: 14px;">
                                                ...
                                                <th  style="text-align: center; font-size: 12px;"><?php
                                                    $sum = $this->agape_model->DisciplinasMatrizImprimirSum($matriz_id, $rowPeriodo['periodo'], 'carga_horaria');
                                                    echo $sum['soma'];
                                                    ?>
                                                <th  style="text-align: center; font-size: 12px;">

                                                    <?php
                                                    $sum = $this->agape_model->DisciplinasMatrizImprimirSum($matriz_id, $rowPeriodo['periodo'], 'credito');
                                                    echo $sum['soma'];
                                                    ?>
