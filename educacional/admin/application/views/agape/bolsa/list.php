            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <header class="panel-heading">
                        <a href="<?php echo base_url(); ?>bolsa/bolsasAdd"><button class="btn btn-primary"><span class="glyphicon glyphicon-plus">
                                </span> BOLSA</button>
                        </a>
                    </header>
                                    ...
                                    foreach ($bolsas as $rowBolsas):
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td class="center hidden-phone">
                                                ...
                                                <a href="<?php echo base_url(); ?>bolsa/update/<?php echo $rowBolsas['bolsas_id']; ?>">
