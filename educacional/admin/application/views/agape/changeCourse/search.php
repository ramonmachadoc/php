<section id="main-content">
    <section class="wrapper">
        ...
        <div class="col-lg-12">
            <section class="panel">
                <div class="panel-heading"><strong><span class="fa fa-search"></span> TROCAR CURSO ALUNO</strong></div>
...
<script>
                                                ...
                                                function buscar_paginacao_receber_pagamento() {
                                                    ...
                                                    if ((aluno) || (curso != '0') || (turma != '0')) {
                                                        var url = '../Registro/searchChange/' + curso + '/' + turma + '/' + aluno + '/' + periodo + '/' + matricula;  //caminho do arquivo php que irá buscar as cidades no BD
                                                        $.get(url, function (dataReturn) {
