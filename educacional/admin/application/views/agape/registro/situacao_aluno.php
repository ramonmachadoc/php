        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url(); ?>ReceberPagamento/pagamentosAlunos/<?php echo $turma['matricula_aluno_id']; ?>"><i class="fa fa-table"></i> SITUAÇÃO ALUNO</a></li>
                    <li class="active"><i class="fa fa-share"></i> DETALHES SITUAÇÃO ALUNO</li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                ...
                                <section class="panel">
                                    <div class="panel-body">
                                        <ul class="summary-list" style="font-size: 13px;">
                                            ...
                                            <li>
                                                <a href="<?php echo base_url(); ?>Registro/ficha_aluno/<?php echo $turma['matricula_aluno_id']; ?>">
                                            ...
                                            <li>
<<<<<<< HEAD
                                                <a href="<?php echo base_url(); ?>Historico/historico_aluno/<?php echo $turma['matricula_aluno_id']; ?>/">
=======
                                                <a href="<?php echo base_url(); ?>Relatorios/relatorio/<?php echo $turma['matricula_aluno_id']; ?>/">
...
>>>>>>> f0ae7bcb402691fa4dab574ee0a7b897e53f4dd4
...
//                                                $dadosBolsa = $this->financeiro_model->CarregaBolsas($rowPeriod['matricula_aluno_turma_id']);
                                                    ...
                                                    <?php
                                                    $dadosAlunoC = $this->agape_model->MatriculaAluno($rowPeriod['matricula_aluno_turma_id']);
                                                    ?>
