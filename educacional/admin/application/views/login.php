...
<body class="login-body">
    <div class="container">
        ...
        <?php echo form_open('login/validate_login', array('class' => 'form-signin')); ?>
         ...
         <h2 class="form-signin-heading">PORTAL FBN - ACADÊMICO</h2>
        <h2 class="form-signin-heading" style="background-image: url(<?php echo base_url(); ?>template/img/bg-topo.png);">
            <img style="margin-left: 0px; margin-bottom: -20px;" src="<?php echo base_url(); ?>template/img/logo_1.png" height="85" width="280" alt="" />
        </h2>
