<section id="main-content">
    <section class="wrapper">
        ...
        <div class="col-lg-10">
            ...
            <section class="panel">
                ...
                <div class="panel-heading"><strong><span class="fa fa-users"></span> NOVO PROFESSOR</strong></div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label>Login</label>
                                                <input type="text" name="login" required="required" id="login"  class="form-control" placeholder="Digite o Login">
                                            </div>
                                        </div>
    ...
    <script src="<?php echo base_url(); ?>template/js/form-validation-script.js?<?php echo $versao; ?>"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>template/js/bootstrap-inputmask.min.js?<?php echo $versao; ?>"></script>
