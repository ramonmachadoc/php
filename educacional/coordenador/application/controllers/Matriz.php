...
class Matriz extends CI_Controller {
    ...
    public function index() {
        ...
        $page_data['matriz'] = $this->coordenador_model->getJoin('matriz', 'cursos', 'matriz_id');
    ...
    public function add() {
        ...
        if ($this->input->post()) {
            ...
            if ($this->coordenador_model->save('matriz', $dados)) {
    ...
    public function disciplinas($param1 = '') {
        ...
        if ($this->input->post()) {
            ...
            $ultimo_id = $this->coordenador_model->save('disciplina', $dadosDisciplina);
            ...
            if ($ultimo_id) {
                ...
                if ($this->coordenador_model->save('matriz_disciplina', $dados)) {
            ...
            $page_data['disciplinas'] = $this->coordenador_model->DisciplinasMatriz($param1);
            $page_data['InfoMatriz'] = $this->coordenador_model->getJoinRow('matriz', 'cursos', 'matriz_id', $param1);
            $page_data['periodos'] = $this->coordenador_model->getTable('periodo');
    ...
    public function deleteDisciplina($param1 = '', $param2 = '') {
        ...
        if ($this->coordenador_model->delete('matriz_disciplina', $param1)) {

            if ($this->coordenador_model->delete('disciplina', $param1)) {
    ...
    public function editDisciplina($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($this->input->post()) {
            ...
            $ultimo_id = $this->coordenador_model->update($dadosDisciplina, 'disciplina', $param2);
            ...
            if ($ultimo_id) {
                ...
                if ($this->coordenador_model->update($dados, 'matriz_disciplina', $param3)) {
            ...
            $page_data['disciplinas'] = $this->coordenador_model->DisciplinasMatriz($param1);
            $page_data['InfoMatriz'] = $this->coordenador_model->getJoinRow('matriz', 'cursos', 'matriz_id', $param3);
            $page_data['periodos'] = $this->coordenador_model->getTable();
            $page_data['matriz_disciplina'] = $this->coordenador_model->getUpdateMatriz($param2);
    ...
    public function imprimir($param1 = '') {
        ...
        $page_data['periodos'] = $this->coordenador_model->DisciplinasMatrizPeriodo($param1);
        $page_data['soma'] = $this->coordenador_model->DiscSumtotal($param1);
        $page_data['InfoMatriz'] = $this->coordenador_model->getJoinRow('matriz', 'cursos', 'matriz_id', $param1);
