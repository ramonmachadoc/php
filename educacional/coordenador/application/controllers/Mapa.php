...
class Mapa extends CI_Controller {
    ...
    public function index() {
        ...
        $page_data['disciplinas'] = $this->coordenador_model->GetMinhasDisciplinas($this->session->userdata('login'));
    ...
    public function Mapa($param1 = '', $param2 = '', $param3 = '') {
        ...
        $page_data['alunos'] = $this->coordenador_model->AlunosNota($param2, $param3);
