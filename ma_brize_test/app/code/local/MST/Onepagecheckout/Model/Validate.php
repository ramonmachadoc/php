<?php
class MST_OnepageCheckout_Model_Validate extends Mage_Sales_Model_Service_Quote
{
    protected function _validate()
    {
        ...
        if (!$this->getQuote()->isVirtual())
        {
            ...
            $addrValidator = Mage::getSingleton('onepagecheckout/data')->validateAddress($address);
        ...
        $addrValidator = Mage::getSingleton('onepagecheckout/data')->validateAddress($this->getQuote()->getBillingAddress());
