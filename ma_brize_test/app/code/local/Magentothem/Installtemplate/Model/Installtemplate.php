...
class Magentothem_Installtemplate_Model_Installtemplate extends Mage_Core_Model_Abstract {
    ...
    public function saveTemplateConfig(int $store) {
		...
		Mage::getConfig()->saveConfig('design/package/name', 'ma_zonker', $scope, $store);
        Mage::getConfig()->saveConfig('design/theme/default', 'ma_zonker1', $scope, $store);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'ma_zonker1_home', $scope, $store);
		Mage::getConfig()->saveConfig('design/theme/default', 'ma_zonker1', 'default', 0);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'ma_zonker1_home', 'default', 0);
