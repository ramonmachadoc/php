<header  id="<?php if(donald_get_option('header_trans')) echo 'header-home-2';else echo 'stick'; ?>" class="header-7 <?php if(donald_get_option('header_trans')) echo 'bg-transparent fixed'; ?>">
