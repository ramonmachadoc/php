...
//		array(
//			'links' => array('Gerenciar Retornos Não Atendidos'),
//		)
//	);
//?>
...
<h3><i class="glyphicon glyphicon-time"></i> Gerenciar Retornos Não Atendidos</h3>
...
<?php
	if (Yii::app()->user->perfil != Funcionario::GERENTE){
		$this->widget('booster.widgets.TbGridView', array(
			...
			'filter' => $model,
			'enableSorting' => true,
			'afterAjaxUpdate' => 'function(link,success,data){
										reinstallDatePicker();
								}',
			'columns' => array(
				'nome',
