            ...
            <?php if( isset(Yii::app()->user->perfil) and Yii::app()->user->getState('perfil') == Permissao::ADMINISTRADOR ) : ?>
                ...
                <li class="sub-menu">
                    <a id="sub-menu-adm-evento" href="javascript:;" >
                        <i class="fa fa-bullhorn"></i> <span>EVENTO</span>
                    </a>
                    <ul class="sub">
                       <li id="admevento-cadastrar">
                            <a href="<?php echo Yii::app()->createUrl('evento/create'); ?>"> Cadastrar </a>
                        </li>
                       <li id="admevento-listar">
                            <a href="<?php echo Yii::app()->createUrl('evento/indexadministrador'); ?>"> Listar </a>
                        </li>
                ...
                <li class="sub-menu">
                    <a id="sub-menu-adm-gerenc" href="javascript:;" >
                        <i class="fa fa-cogs"></i> <span>GERENCIAMENTO</span>
                    </a>
                    <ul class="sub">
                       ...
                       <li id="admgerenc-equip">
                           <a href="<?php echo Yii::app()->createUrl('equipamento/admin'); ?>"> Equipamento e Aeronave</a>
                        </li>
